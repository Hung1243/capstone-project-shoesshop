    ...
    <div className="container">
      <div className="row mt-5">
        ...
        <div className="text-center mt-4">
          ...
          <div className="quantity-selector mt-3 d-flex justify-content-center">
            <button
          ...
          <p className="mt-3"></p>
          <button
            className="btn btn-outline-dark ml-2 mt-2"
      ...
      <h3 className="mt-5 text-center related-title">YOU MIGHT ALSO LIKE</h3>
      <div className="row mb-5">
        {productDetail.relatedProducts?.map((prod) => {
          return (
            <div className="col-12 mt-2 product-container" key={prod.id}>
              <NavLink
